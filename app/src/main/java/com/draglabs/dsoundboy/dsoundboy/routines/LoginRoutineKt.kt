...
class LoginRoutineKt {
    ...
    fun setProfileView(response: JSONObject, activity: Activity, context: Context) {
        ...
        if (email != null) {
            ...
            val pictureView = activity.findViewById<ProfilePictureView>(com.draglabs.dsoundboy.dsoundboy.R.id.user_picture)
            if (pictureView != null) {
                pictureView.presetSize = ProfilePictureView.NORMAL
                pictureView.profileId = id
            }

            val userNameTextView = activity.findViewById<TextView>(com.draglabs.dsoundboy.dsoundboy.R.id.user_name)
            val userEmailTextView = activity.findViewById<TextView>(com.draglabs.dsoundboy.dsoundboy.R.id.user_email)
