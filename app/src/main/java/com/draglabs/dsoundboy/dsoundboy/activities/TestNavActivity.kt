...
class TestNavActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    ...
    private var activeJamPIN: String? = null
    ...
    private fun initializeUIElements() {
        ...
        buttons["new_jam"] = findViewById<Button>(R.id.button_new_jam_new) as Any
        buttons["new_recording"] = rec as Any
        buttons["join_jam"] = findViewById<Button>(R.id.button_join_jam_new) as Any
    }
    ...
    private suspend fun initializeTasks() {
        ...
        setUserView()
        OfflineUploader().queueInteractor(this@TestNavActivity)
    ...
    private fun initializeListeners() {
        ...
        findViewById<Button>(R.id.button_new_jam_new).setOnClickListener {
            clickNew()
            clickRec(it)
        }

        findViewById<Button>(R.id.button_rec_new).setOnClickListener {
            clickRec(it)
        }

        findViewById<Button>(R.id.button_stop_new).setOnClickListener {
            //clickStop(this, recorder)
        }

        findViewById<Button>(R.id.button_join_jam_new).setOnClickListener {
            clickJoin()
            clickRec(it)
        }
    ...
    private fun clickRec(view: View) {
        ...
        if ((activeJamPIN?.length ?: 0) > 4) {
            ...
            HomeRoutineKt().clickRec(this, recorder, recorderUtils, findViewById(R.id.chronometer_new)) // no current jam, recorder button creates a new one
    ...
    private suspend fun clickStop(context: Context, recorder: Recorder) {
        ...
        HomeRoutineKt().clickStop(recorder, recorderUtils, context, findViewById(R.id.chronometer_new))
    ...
    private fun clickJoin() {
        ...
        HomeRoutineKt().joinJam(this, this, findViewById(R.id.jam_pin_view))
        updatePinView()
    }
    ...
    private fun clickNew() {
        ...
        HomeRoutineKt().createJam(this, findViewById(R.id.jam_pin_view))
        updatePinView()
